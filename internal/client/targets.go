...
func (c *Client) BootTarget(ctx context.Context, udid, leaseID string) (proto.Target, error) {
	var t proto.Target
	err := c.leaseDo(ctx, leaseID, http.MethodPost, "/v0/targets/"+url.PathEscape(udid)+"/boot",
...
func (c *Client) BootTargetWait(ctx context.Context, udid, leaseID string) (proto.Target, error) {
	var t proto.Target
	err := c.leaseDo(ctx, leaseID, http.MethodPost, "/v0/targets/"+url.PathEscape(udid)+"/boot?wait=true",
		map[string]string{"lease_id": leaseID}, &t)
	return t, err
}
...
func (c *Client) ShutdownTarget(ctx context.Context, udid, leaseID string) (proto.Target, error) {
	var t proto.Target
	err := c.leaseDo(ctx, leaseID, http.MethodPost, "/v0/targets/"+url.PathEscape(udid)+"/shutdown",
		map[string]string{"lease_id": leaseID}, &t)
	return t, err
}
